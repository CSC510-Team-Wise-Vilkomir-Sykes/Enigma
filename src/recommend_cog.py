...
class RecommendCog(commands.Cog):
	...
	async def recommend(self, ctx):
		...
		Example:
			After selecting favorite songs using `/poll`, a user invokes `/recommend`. The bot responds with a list of recommended songs. The user reacts with the emoji corresponding to a song to add it to their queue or with 🆕 to get a fresh set of recommendations.
